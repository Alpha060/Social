      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-[460px] bg-white rounded-3xl border border-slate-200/60 p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.04)]">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h2 className="text-3xl font-extrabold text-[#1d1d1f] tracking-tight mb-2">Create your account</h2>
            <p className="text-[#86868b] text-sm font-medium">Join our community of verified creators</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label className="block text-[11px] font-bold text-[#86868b] uppercase tracking-wider mb-2 ml-1">Full Name</label>
              <input 
                type="text" 
                value={name}
            ...
            <div>
              <label className="block text-[11px] font-bold text-[#86868b] uppercase tracking-wider mb-2 ml-1">Password</label>
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            ...
            <span className="text-[11px] text-[#86868b] font-bold uppercase tracking-wider">Or sign up with</span>
            <div className="h-px bg-slate-100 flex-1"></div>
          </div>
          ...
          <p className="text-center mt-10 text-xs font-semibold text-[#86868b]">
            Already have an account? <Link href="/login" className="text-[#0071e3] font-bold hover:underline">Login</Link>
          </p>
